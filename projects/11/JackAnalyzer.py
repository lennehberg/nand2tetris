...
from CompilationEngine import CriticalError
from JackTokenizer import JackTokenizer
from SymbolTable import SymbolTable


def handle_error(error: CriticalError):
    print(f"Critical Error Occured: {error.message()}")
...
def analyze_file(
    ...
    engine = CompilationEngine(tokenizer, symtable, output_file)
    try:
        engine.compile_class()
    except CriticalError as critical:
        handle_error(critical)
