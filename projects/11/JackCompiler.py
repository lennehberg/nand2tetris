...
def compile_file(
        input_file: typing.TextIO, output_file: typing.TextIO, xml_file: typing.TextIO) -> None:
    ...
    engine = CompilationEngine(tokenizer, symbol_table, writer, xml_file)
    ...
    for input_path in files_to_assemble:
        ...
        with open(input_path, 'r') as input_file, \
                open(output_path, 'w') as output_file, \
                    open(xml_path, 'w') as xml_file:
            compile_file(input_file, output_file, xml_file)
